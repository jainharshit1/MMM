...
class BudgetOptimization:
    def __init__(self, data, media_channels, model_features, prophet, optimization_percentage=0.2):
        """
    ...
    def historical_response(self, optimization_period):
        ...
        media_channel_average_spend = self.data[self.media_channels].mean(axis=0).values
    ...
    def optimize_budget(self, media_channel_average_spend, media_coefficients, media_hill_slopes, media_hill_half_saturations, media_min_max_ranges, additional_inputs):
        """
        ...
        for i, (min_spend, max_spend) in enumerate(media_min_max_ranges):
            ...
            upper_bound[i] = min(upper_bound[i], max_spend)
        ...
        return solution.x  # Return the optimized media spend
